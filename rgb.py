...
if __name__ == '__main__':
    imgdir = r"/media/ailab/EXTERNAL_USB/sea_drones_see_multispectral/images/train"  # tif文件所在的【文件夹】
    savedir = r"/media/ailab/EXTERNAL_USB/SeeDroneSee/visible/train"  # 转为jpg后存储的【文件夹】
