...
#
target = ['model_20']
# target = ['model_20', 'model_21', 'model_22']
# Arguments
...
parser.add_argument('--model-path', type=str, default='/media/ailab/EXTERNAL_USB/latest/SeaDroneSee/exp292/weights/best.pt', help='Path to the model')
...
# parser.add_argument('--model-path', type=str, default='/media/ailab/5385f1e6-0f46-4865-90c2-287b9a0f3c16/qcy/sea/exp1+64/weights/best.pt', help='Path to the model')
# parser.add_argument('--model-path', type=str, default='/media/ailab/EXTERNAL_USB/latest/SeaDroneSee/exp310/weights/best.pt', help='Path to the model')
# parser.add_argument('--model-path', type=str, default='/media/ailab/EXTERNAL_USB/latest/FLIR/exp85/weights/best.pt', help='Path to the model')
# dataset1
...
parser.add_argument('--output-dir', type=str, default='/media/ailab/5385f1e6-0f46-4865-90c2-287b9a0f3c16/qcy/gradcam/seanew/sea888',
...
def main(img_vis_path, img_ir_path):
    ...
    if img_vis is None or img_ir is None:
        print(f"错误：无法读取图像文件")
        print(f"可见光图像路径: {img_vis_path}")
        print(f"红外图像路径: {img_ir_path}")
        return  # 或者采取其他错误处理措施
    # load model
