...
parser.add_argument('--model-path', type=str, default="/media/ailab/EXTERNAL_USB/icafusion/exp35/weights/best.pt", help='Path to the model')
parser.add_argument('--source1', type=str, default='/media/ailab/EXTERNAL_USB/VEDAI/fold01/visible/test', help='source')  # file/folder, 0 for webcam
parser.add_argument('--source2', type=str, default='/media/ailab/EXTERNAL_USB/VEDAI/fold01/infrared/test', help='source')  # file/folder, 0 for webcam
parser.add_argument('--output-dir', type=str, default='/media/ailab/EXTERNAL_USB/icafusion/camgram', help='output dir')
...
parser.add_argument('--names', type=str, default='car, truck, pickup, tractor, camper, ship, van, plane, other',
